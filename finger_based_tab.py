...
with mp_hands.Hands(
    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            ...
            cv2.putText(image, f'Fingers: {finger_count}', (image.shape[1] - 150, image.shape[0] - 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
            cv2.putText(image, f'Direction: {direction}', (10, image.shape[0] - 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
